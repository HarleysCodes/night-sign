        ...
        <div className="flex gap-6 items-center">
          ...
          {isConnected ? (
             <div className="flex items-center gap-3">
                <span className="text-sm font-medium text-slate-600 dark:text-slate-300 bg-slate-100 dark:bg-black/30 px-3 py-1.5 rounded-lg border border-slate-200 dark:border-white/10">{accountId && accountId !== "connected" ? `${accountId.slice(0, 6)}...${accountId.slice(-4)}` : "Wallet"}</span>
             </div>
          ) : (
