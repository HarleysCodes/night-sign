...
function App() {
  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'space-bg' : 'bg-slate-50'}`}>
      <nav className="w-full flex justify-between items-center px-6 py-4 bg-white/80 dark:bg-white/5 backdrop-blur-md border-b border-slate-200 dark:border-white/10 sticky top-0 z-50">
